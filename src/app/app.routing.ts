...
export const appRoutes: Route[] = [
    ...
    {path: '', pathMatch : 'full', redirectTo: 'pages/profile'},
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'apps', children: [
                ...
                {path: 'jeu', loadChildren: () => import('app/modules/admin/apps/jeu/jeu.module').then(m => m.JeuModule)},
            ...
            {path: 'pages', children: [
                ...
                {path: 'plann', loadChildren: () => import('app/modules/admin/pages/plan/plan.module').then(m => m.PlanModule)},
