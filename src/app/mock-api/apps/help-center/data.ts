...
export const faqs = [
    // Most asked
    {
        ...
        answer    : ' Pour créer un compte sur notre plateforme, suivez ces étapes simples  Cliquez sur le bouton inscrire ou Créer un compte situé en haut de la page d accuei Remplissez le formulaire d inscription en fournissant vos informations personnelles telles que votre nom, votre adresse e-mail et un mot de passe sécurisé Une fois le formulaire rempli, cliquez sur le bouton S inscrire  ou Créer un compte Vous recevrez un e-mail de confirmation. Cliquez sur le lien de confirmation pour activer votre compte. Félicitations ! Votre compte a été créé avec succès. Vous pouvez maintenant vous connecter et commencer à explorer notre plateforme.'
    },
    {
        id        : '0fcece82-1691-4b98-a9b9-b63218f9deef',
        categoryId: '28924eab-97cc-465a-ba21-f232bb95843f',
        question  : 'Comment puis-je rechercher des produits spécifiques sur votre plateforme ?',
        answer    : 'Pour rechercher des produits spécifiques sur notre plateforme, suivez ces étapes Utilisez la barre de recherche située en haut de la page d accueil'
    },
    {
        id        : '2e6971cd-49d5-49f1-8cbd-fba5c71e6062',
        categoryId: '28924eab-97cc-465a-ba21-f232bb95843f',
        question  : 'Comment puis-je retourner un produit que j ai acheté sur votre plateforme ?',
        answer    : 'Nous comprenons que parfois, un produit peut ne pas répondre entièrement à vos attentes. Pour faciliter le processus de retour, veuillez suivre ces étapes simples'
    },
    {
        id        : '974f93b8-336f-4eec-b011-9ddb412ee828',
        categoryId: '28924eab-97cc-465a-ba21-f232bb95843f',
        question  : 'Quels sont les modes de paiement acceptés sur votre plateforme ?',
        answer    : 'Nous acceptons plusieurs modes de paiement pour rendre votre expérience d achat pratique et sécurisée. Voici les modes de paiement que nous acceptons actuellement :Cartes de crédit/débit : Nous acceptons les principales cartes de crédit et de débit, telles que Visa, Mastercard, American Express, etc.'
    },
