...
import { contacts as contactsData, countries as countriesData, tags as tagsData } from 'app/mock-api/apps/store/data';
...
export class ContactsMockApi
{
    ...
    */
    ...
    registerHandlers(): void
    {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('api/apps/store/contact')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('api/apps/store/contact')
            .reply(({request}) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/apps/store/countries')
