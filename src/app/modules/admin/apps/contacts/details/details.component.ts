...
export class ContactsDetailsComponent implements OnInit, OnDestroy
{
    ...
    updateContact(): void
    {
        ...
        this._contactsService.updateContact(contact._id, contact).subscribe(() => {
            // Toggle the edit mode off
            this.toggleEditMode(false);
        });
    }
    ...
    deleteContact(): void
    {
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if ( result === 'confirmed' )
            {
                ...
                const currentContactIndex = this.contacts.findIndex(item => item._id === id);
                const nextContactIndex = currentContactIndex + ((currentContactIndex === (this.contacts.length - 1)) ? -1 : 1);
                const nextContactId = (this.contacts.length === 1 && this.contacts[0]._id === id) ? null : this.contacts[nextContactIndex]._id;
    ...
    uploadAvatar(fileList: FileList): void
    {
        ...
        // Upload the avatar
        this._contactsService.uploadAvatar(this.contact._id, file).subscribe();
    }
    ...
    filterTagsInputKeyDown(event): void
    {
        ...
        const isTagApplied = this.contact.tags.find(id => id === tag._id);
    ...
    updateTagTitle(tag: Tag, event): void
    {
        ...
        this._contactsService.updateTag(tag._id, tag)
    ...
    deleteTag(tag: Tag): void
    {
        ...
        this._contactsService.deleteTag(tag._id).subscribe();
    ...
    {
        // Add the tag
        this.contact.tags.unshift(tag._id);
    ...
    {
        // Remove the tag
        this.contact.tags.splice(this.contact.tags.findIndex(item => item === tag._id), 1);
    ...
    {
        if ( this.contact.tags.includes(tag._id) )
        {
            this.removeTagFromContact(tag);
        }
        else
